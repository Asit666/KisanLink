export const LANGUAGE_TEXT = {
  en: {
    ...
    weatherEyebrow: 'Local weather and harvest advisory',
    weatherTitle: 'Weather, harvest timing, and spoilage risk',
    weatherLive: 'Live Open-Meteo data',
    weatherFallback: 'Offline estimate',
    weatherOrigin: 'Location:',
    weatherUseGps: 'Use profile GPS',
    weatherGeneralConditions: 'General conditions (all crops)',
    weatherCondition: 'Condition',
    weatherSuitability: 'Harvest suitability',
    weatherHumidity: 'Humidity',
    weatherRainfall: 'Rainfall',
    weatherWind: 'Wind speed',
    weatherHarvestWindow: 'Recommended harvest window',
    weatherSpoilageRisk: 'Produce transit spoilage risk',
    weatherRisk: 'Risk',
    weatherGuidelines: 'Crop protection and post-harvest guidance',
    weatherForecast: '5-day weather forecast',
    weatherLoading: 'Loading live weather and harvest guidance...',
    weatherUnavailable: 'Weather data is unavailable. Please select a location again.',
    weatherRain: 'Rain',
    weatherAnalyzing: 'Analyzing',
    ...
    signOut: 'Sign Out',
    heroEyebrow: 'Agricultural Trade & Mandi Intelligence',
    heroTitle: 'Better prices. Directly to the farm.',
    heroTitlePart1: 'Better prices.',
    heroTitlePart2: 'Directly to the farm.',
    heroCopy: "India's agricultural trade desk — live mandi rates, FPO lot aggregation, buyer matching, and escrow-protected settlements.",
  ...
  hi: {
    ...
    weatherEyebrow: 'स्थानीय मौसम और फसल सलाह',
    weatherTitle: 'मौसम, कटाई का समय और खराब होने का जोखिम',
    weatherLive: 'लाइव Open-Meteo डेटा',
    weatherFallback: 'ऑफलाइन अनुमान',
    weatherOrigin: 'स्थान:',
    weatherUseGps: 'प्रोफाइल GPS इस्तेमाल करें',
    weatherGeneralConditions: 'सामान्य स्थिति (सभी फसलें)',
    weatherCondition: 'स्थिति',
    weatherSuitability: 'कटाई की उपयुक्तता',
    weatherHumidity: 'नमी',
    weatherRainfall: 'वर्षा',
    weatherWind: 'हवा की गति',
    weatherHarvestWindow: 'अनुशंसित कटाई समय',
    weatherSpoilageRisk: 'उपज परिवहन खराब होने का जोखिम',
    weatherRisk: 'जोखिम',
    weatherGuidelines: 'फसल सुरक्षा और कटाई के बाद की सलाह',
    weatherForecast: '5-दिन का मौसम पूर्वानुमान',
    weatherLoading: 'लाइव मौसम और कटाई सलाह लोड हो रही है...',
    weatherUnavailable: 'मौसम डेटा उपलब्ध नहीं है। कृपया स्थान फिर से चुनें।',
    weatherRain: 'वर्षा',
    weatherAnalyzing: 'विश्लेषण जारी',
    ...
    signOut: 'साइन आउट',
    heroEyebrow: 'कृषि व्यापार एवं मंडी भाव सूचना',
    heroTitle: 'बेहतर कीमतें। सीधे खेत तक।',
    heroTitlePart1: 'बेहतर कीमतें।',
    heroTitlePart2: 'सीधे खेत तक।',
    heroCopy: 'भारत का कृषि व्यापार मंच — लाइव मंडी भाव, एफपीओ लॉट एकत्रीकरण, खरीदार मिलान और एस्क्रो-सुरक्षित भुगतान।',
  ...
  mr: {
    ...
    weatherEyebrow: 'स्थानिक हवामान आणि कापणी सल्ला',
    weatherTitle: 'हवामान, कापणीची वेळ आणि खराब होण्याचा धोका',
    weatherLive: 'लाइव्ह Open-Meteo डेटा',
    weatherFallback: 'ऑफलाइन अंदाज',
    weatherOrigin: 'स्थान:',
    weatherUseGps: 'प्रोफाइल GPS वापरा',
    weatherGeneralConditions: 'सामान्य स्थिती (सर्व पिके)',
    weatherCondition: 'स्थिती',
    weatherSuitability: 'कापणीची उपयुक्तता',
    weatherHumidity: 'आर्द्रता',
    weatherRainfall: 'पाऊस',
    weatherWind: 'वाऱ्याचा वेग',
    weatherHarvestWindow: 'शिफारस केलेली कापणीची वेळ',
    weatherSpoilageRisk: 'माल वाहतुकीत खराब होण्याचा धोका',
    weatherRisk: 'धोका',
    weatherGuidelines: 'पीक संरक्षण आणि कापणीनंतरचा सल्ला',
    weatherForecast: '5-दिवसांचा हवामान अंदाज',
    weatherLoading: 'लाइव्ह हवामान आणि कापणी सल्ला लोड होत आहे...',
    weatherUnavailable: 'हवामान डेटा उपलब्ध नाही. कृपया स्थान पुन्हा निवडा.',
    weatherRain: 'पाऊस',
    weatherAnalyzing: 'विश्लेषण सुरू',
    ...
    signOut: 'साइन आउट',
    heroEyebrow: 'शेती व्यापार व थेट बाजारभाव माहिती',
    heroTitle: 'चांगले भाव. थेट शेतापर्यंत.',
    heroTitlePart1: 'चांगले भाव.',
    heroTitlePart2: 'थेट शेतापर्यंत.',
    heroCopy: 'भारताचे कृषी व्यापार व्यासपीठ — थेट बाजार भाव, एफपीओ लॉट संकलन, खरेदीदार जुळवणी आणि एस्क्रो-संरक्षित खात्रीशीर पेमेंट.',
