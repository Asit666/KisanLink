export const LANGUAGE_TEXT = {
  en: {
    ...
    heroTitle: 'KisanLink Trade Exchange',
    heroCopy: 'Direct farmer-buyer market linkages, verified APMC mandi prices, smart freight routing, and secure digital escrow settlements.',
  ...
  hi: {
    ...
    heroTitle: 'KisanLink कृषि एक्सचेंज',
    heroCopy: 'सीधे किसान-खरीदार व्यापार, सत्यापित मंडी भाव, भरोसेमंद ढुलाई और डिजिटल एस्क्रो सुरक्षित भुगतान।',
  ...
  mr: {
    ...
    heroTitle: 'KisanLink कृषी एक्सचेंज',
    heroCopy: 'थेट शेतकरी-व्यापारी व्यवहार, अधिकृत बाजार समिती भाव, खात्रीशीर वाहतूक आणि डिजिटल एस्क्रो सुरक्षित देयके.',
